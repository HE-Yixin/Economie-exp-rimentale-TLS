        ...
        if ($participantexiste == TRUE)
        {
		  $sqlgagne = "SELECT * FROM participant WHERE Gagner = '' and Num_Etu = '$gain'";
              ...
              die("erreur fonction numéro");
			     ...
			     {
				/* Si non, enregistrer le résultat du jeu perdu en "oui" dans la BD. */ 	 
		          $sqlgagne="update participant set Gagner='oui' where Num_Etu=$gain";
		          $updategagne= mysqli_query($cx,$sqlgagne);
